        ...
        for(var i=0;i<tickerArr.length;i++){
            ...
            request(link, function (error, response, body) {
                if (!error && response.statusCode == 200) {
                    ...
                    console.log('^^^^',info,info.query.count);
...
module.exports.alertDataGet = function(res){
    var connection = createConnection();
    var queryString = "call stockly.sp_get_alerts('2017-01-19');";
...
module.exports.alertPivotDataGet = function(res){
    var connection = createConnection();
    var queryString = "call stockly.sp_get_alerts_pivot('2016-10-01');" //" + formattedDate() + "');"; //2017-01-20');"; /(select max(date) from alerts);
    console.log('&&&',queryString);
